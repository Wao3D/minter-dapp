...
const extraMetadata = {
  external_url: "https://cooupers.club", // Replace with your website or remove this line if you do not have one.
};
...
const CONTRACT_NAME = 'Cooupers';
const CONTRACT_SYMBOL = 'CuP';
const METADATA_UPDATABLE = true; // set to false if you don't want to allow metadata updates after minting
const OWNER_ADDRESS = '0x7BC92CCba46c1C5A1C365F5621FA29736ae0E5be';
...
const MINT_PRICE = 0.00001; // Minting price per NFT. Rinkeby = ETH, Ethereum = ETH, Polygon = MATIC. CANNOT BE UPDATED!
...
const PRESALE_WHITELISTED_ADDRESSES = ["0x7BC92CCba46c1C5A1C365F5621FA29736ae0E5be","0x8ab818EA2c138cD64CBc7A4Ca78dd687aCEd2079","0xc7c8a22257D4394eC90ef88FDCb63b3A8583b4B3"]; // only update if you want to manually set the whitelisted addresses
...
const GENERIC_DESCRIPTION = "Come join the wonderful world of Cooupers, a NFT collection of 10.000 octopus with plenty of variations and styles, get yours until it's swims away."; // Replace with what you want the generic descriptions to say.
